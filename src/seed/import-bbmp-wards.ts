...
const wardData = {
  central: {
    ...
    state: 'Karnataka',
    wards: [
      { ward_id: 1, ward_name: 'Ramaswamy Palya', ward_name_l1: 'ರಾಮಸ್ವಾಮಿ ಪಾಳ್ಯ' },
      { ward_id: 2, ward_name: 'Jayamahal', ward_name_l1: 'ಜಯಮಹಲ್' },
      { ward_id: 3, ward_name: 'Vasanth Nagar', ward_name_l1: 'ವಸಂತ್ ನಗರ' },
      { ward_id: 4, ward_name: 'Sampangirama Nagar', ward_name_l1: 'ಸಂಪಂಗಿರಾಮ ನಗರ' },
      ...
      { ward_id: 9, ward_name: 'Hoysala Nagara Central', ward_name_l1: 'ಹೊಯ್ಸಳ ನಗರ ಸೆಂಟ್ರಲ್' },
      { ward_id: 10, ward_name: 'Cox Town', ward_name_l1: 'ಕಾಕ್ಸ್ ಟೌನ್' },
      { ward_id: 11, ward_name: 'Old Baiyappanahalli', ward_name_l1: 'ಓಲ್ಡ್ ಬೈಯ್ಯಪ್ಪನಹಳ್ಳಿ' },
      { ward_id: 12, ward_name: 'Kasturi Nagar', ward_name_l1: 'ಕಸ್ತೂರಿ ನಗರ' },
      { ward_id: 13, ward_name: 'Krishnaiahnapalya', ward_name_l1: 'ಕೃಷ್ಣಯ್ಯನಪಾಳ್ಯ' },
      { ward_id: 14, ward_name: 'Nagavarapalya', ward_name_l1: 'ನಾಗವರಪಾಳ್ಯ' },
      { ward_id: 15, ward_name: 'Indiranagar', ward_name_l1: 'ಇಂದಿರಾನಗರ' },
      { ward_id: 16, ward_name: 'New Thippasandra', ward_name_l1: 'ನ್ಯೂ ತಿಪ್ಪಸಂದ್ರ' },
      { ward_id: 17, ward_name: 'Kaggadasapura', ward_name_l1: 'ಕಗ್ಗದಾಸಪುರ' },
      { ward_id: 18, ward_name: 'G.M Palya', ward_name_l1: 'ಜಿ.ಎಂ. ಪಾಳ್ಯ' },
      { ward_id: 19, ward_name: 'Jeevan Bhimanagar', ward_name_l1: 'ಜೀವನ್ ಭೀಮನಗರ' },
      { ward_id: 20, ward_name: 'Kodihalli', ward_name_l1: 'ಕೋಡಿಹಳ್ಳಿ' },
      { ward_id: 21, ward_name: 'Konena Agrahara', ward_name_l1: 'ಕೋಣೆನ ಅಗ್ರಹಾರ' },
      ...
      { ward_id: 27, ward_name: 'Ambedkarnagar', ward_name_l1: 'ಅಂಬೇಡ್ಕರ್‌ನಗರ' },
      ...
      { ward_id: 32, ward_name: 'SilverJubliee Park', ward_name_l1: 'ಸಿಲ್ವರ್ ಜುಬ್ಲಿ ಪಾರ್ಕ್' },
      { ward_id: 33, ward_name: 'Dharmaraya Swamy Temple', ward_name_l1: 'ಧರ್ಮರಾಯ ಸ್ವಾಮಿ ದೇವಸ್ಥಾನ' },
      { ward_id: 34, ward_name: 'D.V Gundappa', ward_name_l1: 'ಡಿ ವಿ ಗುಂಡಪ್ಪ' },
      { ward_id: 35, ward_name: 'Hombegowda Nagara', ward_name_l1: 'ಹೊಂಬೇಗೌಡ ನಗರ' },
      { ward_id: 36, ward_name: 'Someshwara Nagara', ward_name_l1: 'ಸೋಮೇಶ್ವರ ನಗರ' },
      { ward_id: 37, ward_name: 'BHEL', ward_name_l1: 'ಬಿಎಚ್‌ಇಎಲ್' },
      { ward_id: 38, ward_name: 'Kanakanapalya', ward_name_l1: 'ಕನಕನಪಾಳ್ಯ' },
      { ward_id: 39, ward_name: 'Venkat Reddy Nagara', ward_name_l1: 'ವೆಂಕಟ್ ರೆಡ್ಡಿ ನಗರ' },
      ...
      { ward_id: 46, ward_name: 'Cheluvadi Palya', ward_name_l1: 'ಚೆಲುವಾಡಿ ಪಾಳ್ಯ' },
      { ward_id: 47, ward_name: 'IPD Salappa', ward_name_l1: 'ಐಪಿಡಿ ಸಾಲಪ್ಪ' },
      { ward_id: 48, ward_name: 'Azad Nagar', ward_name_l1: 'ಆಜಾದ್ ನಗರ' },
      { ward_id: 49, ward_name: 'Kasturbha Nagar', ward_name_l1: 'ಕಸ್ತೂರ್ಭಾ ನಗರ' },
      { ward_id: 50, ward_name: 'JJR Nagara', ward_name_l1: 'ಜೆಜೆಆರ್ ನಗರ' },
      { ward_id: 51, ward_name: 'Old Guddadahalli', ward_name_l1: 'ಹಳೆ ಗುಡ್ಡದಹಳ್ಳಿ' },
      ...
      { ward_id: 55, ward_name: 'Bhuvaneshwari Nagar', ward_name_l1: 'ಭುವನೇಶ್ವರಿ ನಗರ' },
      ...
      { ward_id: 62, ward_name: 'Swatantra Palya', ward_name_l1: 'ಸ್ವತಂತ್ರ ಪಾಳ್ಯ' },
  ...
  east: {
    ...
    state: 'Karnataka',
    wards: [
      { ward_id: 1, ward_name: 'K Narayanapura', ward_name_l1: 'ಕೆ. ನಾರಾಯಣಪುರ' },
      ...
      { ward_id: 5, ward_name: 'Hoysala Nagara East', ward_name_l1: 'ಹೊಯ್ಸಳ ನಗರ ಪೂರ್ವ' },
      { ward_id: 6, ward_name: 'Kalkere', ward_name_l1: 'ಕಲ್ಕೆರೆ' },
      { ward_id: 7, ward_name: 'K Chennasandra', ward_name_l1: 'ಕೆ. ಚೆನ್ನಸಂದ್ರ' },
      ...
      { ward_id: 13, ward_name: 'Rajarajeshwari Temple', ward_name_l1: 'ರಾಜರಾಜೇಶ್ವರಿ ದೇವಸ್ಥಾನ' },
      { ward_id: 14, ward_name: 'K.R Pura', ward_name_l1: 'ಕೆ.ಆರ್.ಪುರ' },
      { ward_id: 15, ward_name: 'Ramamurthy Nagara', ward_name_l1: 'ರಾಮಮೂರ್ತಿ ನಗರ' },
      ...
      { ward_id: 19, ward_name: 'K.S. Nissar Ahmed', ward_name_l1: 'ಕೆ.ಎಸ್. ನಿಸಾರ್ ಅಹ್ಮದ್ ' },
      { ward_id: 20, ward_name: 'A Narayanapura', ward_name_l1: 'ಎ. ನಾರಾಯಣಪುರ' },
      ...
      { ward_id: 25, ward_name: 'L.B Shastri Nagar', ward_name_l1: 'ಎಲ್.ಬಿ. ಶಾಸ್ತ್ರಿ ನಗರ' },
      ...
      { ward_id: 35, ward_name: 'Garudachar Palya', ward_name_l1: 'ಗರುಡಾಚಾರ್ ಪಾಳ್ಯ' },
      ...
      { ward_id: 43, ward_name: 'Dodda Nekkundi', ward_name_l1: 'ದೊಡ್ಡ ನೆಕ್ಕುಂಡಿ' },
      ...
      { ward_id: 49, ward_name: 'Doddakannelli', ward_name_l1: 'ದೊಡ್ಡಕನ್ನೆಲ್ಲಿ' },
...
async function importWards() {
  ...
  for (const ward of wardData.central.wards) {
    const existing = await wardRepo.findOne({ where: { number: ward.ward_id.toString() } });
    if (existing) {
