...
export class MediaController {
  ...
  @ApiQuery({ name: 'key', description: 'S3 object key (e.g. profiles/20/file.jpg)', required: true })
  @ApiQuery({ name: 'expires', description: 'Expiry in seconds (default 3600)', required: false })
  @ApiResponse({ status: 200, description: 'Presigned URL returned' })
  async getPresignedUrl(@Query('key') key: string, @Query('expires') expires?: string) {
  ...
  @ApiBody({
    schema: {
      ...
      properties: {
        documentType: {
          type: 'string',
          enum: ['sop', 'sop_kannada', 'agreement', 'property_declaration', 'code_of_conduct', 'resume', 'epic_card', 'epic_card_back', 'address_proof', 'recent_photo', 'selfie'],
  ...
  @ApiParam({ name: 'aspirantId', type: 'number', description: 'Aspirant ID', example: 13 })
  @ApiParam({
    name: 'documentType',
  ...
  @ApiBody({
    schema: {
      ...
      properties: {
        documentType: {
          type: 'string',
          enum: ['sop', 'sop_kannada', 'agreement', 'property_declaration', 'code_of_conduct'],
  ...
  @ApiResponse({ status: 200, description: 'Global document uploaded successfully' })
  @ApiResponse({ status: 403, description: 'Forbidden - Admin role required' })
  ...
  @ApiResponse({ status: 200, description: 'List of active global documents returned' })
  ...
  @ApiResponse({ status: 200, description: 'Signed document uploaded successfully' })
  ...
  @ApiResponse({ status: 200, description: 'List of user\'s signed documents returned' })
  ...
  @ApiResponse({ status: 200, description: 'List of all signed documents returned' })
  @ApiResponse({ status: 403, description: 'Forbidden - Admin role required' })
  ...
  @ApiResponse({ status: 200, description: 'Signed document verification status updated' })
  @ApiResponse({ status: 403, description: 'Forbidden - Admin role required' })
