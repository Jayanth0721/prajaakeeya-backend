...
export class ParliamentaryController {
  ...
  @ApiResponse({ status: 201, description: 'Parliamentary constituency created successfully' })
  @ApiResponse({ status: 409, description: 'Parliamentary constituency already exists' })
  ...
  @ApiResponse({ status: 200, description: 'Parliamentary constituencies retrieved successfully' })
  ...
  @ApiParam({ name: 'id', type: 'number', description: 'Parliamentary constituency ID', example: 1 })
  @ApiResponse({ status: 200, description: 'Parliamentary constituency retrieved successfully' })
  @ApiResponse({ status: 404, description: 'Parliamentary constituency not found' })
