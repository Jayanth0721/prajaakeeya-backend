...
export class User extends BaseEntity {
  ...
  @Column({ name: 'ps_long', type: 'decimal', precision: 10, scale: 6, nullable: true })
  psLong?: number;

  @Column({ name: 'ps_lat', type: 'decimal', precision: 10, scale: 6, nullable: true })
  psLat?: number;
  ...
  @Column({ name: 'password_salt', type: 'varchar', length: 64, nullable: true })
  passwordSalt?: string;
}
