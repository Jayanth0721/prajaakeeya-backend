...
export class AdminController {
  ...
  @ApiQuery({ name: 'wardNumber', required: false, type: 'string', description: 'Filter by ward number' })
  ...
  @Get('voter-counts')
  @ApiOperation({ summary: 'Get voter counts for all wards or specific ward numbers' })
  @ApiQuery({ name: 'wardNumbers', required: false, type: 'string', description: 'Comma-separated ward numbers e.g. W-94,W-95' })
  @ApiResponse({ status: 200, description: 'Voter counts returned successfully' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  ...
  @ApiResponse({ status: 201, description: 'Parliamentary constituency created' })
  ...
  @ApiParam({ name: 'id', type: 'number' })
  @ApiResponse({ status: 200, description: 'Parliamentary constituency updated' })
  @ApiResponse({ status: 404, description: 'Not found' })
  updateParliamentary(@Param('id') id: string, @Body() dto: CreateParliamentaryDto) {
  ...
  @ApiResponse({ status: 404, description: 'Not found' })
  updateMunicipality(@Param('id') id: string, @Body() dto: CreateMunicipalityDto) {
  ...
  @ApiResponse({ status: 404, description: 'Not found' })
  updateGramaPanchayat(@Param('id') id: string, @Body() dto: CreateGramaPanchayatDto) {
  ...
  @ApiResponse({ status: 200, description: 'Voting window returned successfully' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  ...
  @ApiResponse({ status: 200, description: 'Voting windows returned successfully' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  getAllVotingWindows() {
